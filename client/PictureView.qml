...
Rectangle{
    ...
    {
        image.source="image://hdimageprovider/"+value;
    }
    ...
    function adjustWindowSize() {
        ...
        var imgWidth = image.sourceSize.width;
        var imgHeight = image.sourceSize.height;
    ...
    Flickable {
        ...
        Image {
            id: image
            width: sourceSize.width * currentScale
            height: sourceSize.height * currentScale
    ...
    Rectangle {
        ...
        Row {
            ...
            Rectangle{
                ...
                Image {
                    anchors.fill: parent;
                    source: "/new/prefix1/res/big.svg"
                }
                MouseArea{
                    anchors.fill: parent;
            ...
            Rectangle{
                ...
                Image {
                    anchors.fill: parent;
                    source: "/new/prefix1/res/small.svg"
                }
                MouseArea{
                    anchors.fill: parent;
                    cursorShape: Qt.PointingHandCursor;
